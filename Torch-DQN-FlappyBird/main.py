...
parser.add_argument('--train', action='store_true', default=True,help='If set true, train the model; otherwise, play game with pretrained model')
parser.add_argument('--cuda', action='store_true', default=True,help='If set true, with cuda enabled; otherwise, with CPU only')
parser.add_argument('--weight', type=str,help='weight file name for finetunig(Optional)', default='model_best.pth.tar')
...
parser.add_argument('--init_e', type=float,help='initial epsilon for epsilon-greedy exploration',default=1.0)
parser.add_argument('--final_e', type=float,help='final epsilon for epsilon-greedy exploration',default=0.1)
parser.add_argument('--observation', type=int,help='random observation number in the beginning before training',default=100)
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        play_game(args.weight, args.cuda, True,best=False)
