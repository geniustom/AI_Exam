...
class Predictor:
    def __init__(self):
        ...
        self.model.load_weights("models/face_age_gender.h5")
        ...
        self.model_ga.load_weights("models/face_age_gender.h5", by_name=True)
        
        # back_model predict emotion
        self.model_e = emotion_net()
        self.model_e.load_weights("models/emotion.h5")
